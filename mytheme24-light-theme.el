(deftheme mytheme24-light "my custom theme light")
(custom-theme-set-faces
  'mytheme24-light
  '(default ((t (:foreground "#f5f6f7" :background "#000000"))))
  '(cursor ((t (:background "#cbc757"))))
  '(fringe ((t (:background "#242424"))))
  '(mode-line ((t (:foreground "#c2c2c2" :background "#4a4a4a"))))
  '(region ((t (:background "#484841"))))
  '(font-lock-builtin-face ((t (:foreground "#2e93ff"))))
  '(font-lock-comment-face ((t (:foreground "#757575"))))
  '(font-lock-function-name-face ((t (:foreground "#f00000"))))
  '(font-lock-keyword-face ((t (:foreground "#46adff"))))
  '(font-lock-string-face ((t (:foreground "#f07500"))))
  '(font-lock-type-face ((t (:foreground"#77d746"))))
  '(font-lock-constant-face ((t (:foreground "#ff8ae8"))))
  '(font-lock-variable-name-face ((t (:foreground "#eeee91"))))
  '(minibuffer-prompt ((t (:foreground "#fdfdfd" :bold t))))
